...
;;       described in the ParselTongue specification!)    
	...
	;; Milestone Methods
	[Prim1C (op arg)  (v*s (StrV (expr-to-string arg)) store)] ;; only works for print
	
	;;[GetFieldC (obj : ExprC) (field : ExprC)]
	;;[SetFieldC (obj : ExprC) (field : ExprC) (value : ExprC)]
	
	[GetFieldC (obj field) (interp-error (string-append "Non-object in field lookup: " (string-append (expr-to-string obj) "" )))]
	[SetFieldC (obj field value) (interp-error (string-append "Non-object in field update: " (expr-to-string obj)))]
	
	;;[Set!C (id value) (interp-error (string-append "Unbound identifier: " (symbol->string id)))]
	
	[Prim2C (op arg1 arg2)
		(case op
			['+ (interp-error "Bad arguments to +")]
			[else (interp-error (string-append "Bad arguments for " (string-append (symbol->string op) (string-append ":\n" (string-append (expr-to-string arg1) (string-append "\n" (expr-to-string arg2)))))))]
		)
	]
	
	[ObjectC (fields) (v*s (StrV "") store)]
	[LetC (id bind body) (interp-error "Bad arguments to +")]
	[AppC (func args) (interp-error "Application failed with arity mismatch")]
	;;[SeqC (e1 e2) (v*s (StrV "") store)]
	

	
	
	;;[ErrorC (e) (interp-error (interp-full e v*s store))]
